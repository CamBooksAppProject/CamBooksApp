      ...
      {isShowSplash ? (<SplashScreen />) : (
        <NavigationContainer>
          <Stack.Navigator initialRouteName="LoginScreen">
            ...
            <Stack.Screen name="ChatDetailPage" component={ChatDetailPage} options={{ headerShown: false }} />
            ...
            <Stack.Screen name="SettingModal" component={SettingModal} options={{ headerShown: false }} />
